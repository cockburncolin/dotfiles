return {
  ...
  keys = {
    ...
    -- search
    { '<leader>h"', function() Snacks.picker.registers() end, desc = "Registers" },
    ...
    { "<leader>hb", function() Snacks.picker.lines() end, desc = "Buffer Lines" },
    ...
    { "<leader>hd", function() Snacks.picker.diagnostics() end, desc = "Diagnostics" },
    { "<leader>hD", function() Snacks.picker.diagnostics_buffer() end, desc = "Buffer Diagnostics" },
    { "<leader>hh", function() Snacks.picker.help() end, desc = "Help Pages" },
    { "<leader>hH", function() Snacks.picker.highlights() end, desc = "Highlights" },
    { "<leader>hi", function() Snacks.picker.icons() end, desc = "Icons" },
    { "<leader>hj", function() Snacks.picker.jumps() end, desc = "Jumps" },
    { "<leader>hk", function() Snacks.picker.keymaps() end, desc = "Keymaps" },
    { "<leader>hl", function() Snacks.picker.loclist() end, desc = "Location List" },
    { "<leader>hm", function() Snacks.picker.marks() end, desc = "Marks" },
    { "<leader>hM", function() Snacks.picker.man() end, desc = "Man Pages" },
    { "<leader>hp", function() Snacks.picker.lazy() end, desc = "Search for Plugin Spec" },
    { "<leader>hq", function() Snacks.picker.qflist() end, desc = "Quickfix List" },
    { "<leader>hR", function() Snacks.picker.resume() end, desc = "Resume" },
